...
def commit() -> Tuple[Response, int]:
    ...
    # don't log commit status requests, since these might be sent frequently by a script, clogging the API req history.
    if status_code == 200 and not (action == 'status'):
