...
This page merely presents a set of 3 Bootstrap Cards that link to detail pages for exploring the different research
projects underway in the laboratory; searching for behavioral and/or neuronal data sets by experiment session; and
searching the table of all neural unit recordings in the database.
